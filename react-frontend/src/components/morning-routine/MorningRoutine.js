...
export default function MorningRoutine ({ morningRoutines, updateMorningRoutine}) {
    ...
    return (
        <div className={classes.morning_routine}>
            <ProgressBar />
            <Header text = "What does your morning skin care routine look like?" />
